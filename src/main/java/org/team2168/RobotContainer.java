...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        driverJoystick.leftTrigger()
                .whileTrue(
                        swerve.runDriveWithJoystick(driverJoystick, MaxSpeed / Constants.DrivePIDConstants.SLOW_FACTOR,
                                MaxAngularRate / Constants.DrivePIDConstants.SLOW_FACTOR));

        driverJoystick.back().onTrue(swerve.applyRequest(
                () -> new SwerveRequest.PointWheelsAt().withModuleDirection(Rotation2d.fromDegrees(180))));
        ...
        operatorJoystick.rightTrigger()
                .onTrue(Commands.parallel(
                        new SetCoralPivotAngle(coralPivot, CORAL_PIVOT_POSITION.ZERO.getPivotPositon()),
        ...
        operatorJoystick.rightBumper()
                .onTrue((Commands.parallel(
                        new SetCoralPivotAngle(coralPivot, CORAL_PIVOT_POSITION.INTAKE.getPivotPositon()),
        ...
        operatorJoystick.a()
                .onTrue(Commands.parallel(
                        new SetCoralPivotAngle(coralPivot, CORAL_PIVOT_POSITION.BARGE.getPivotPositon()),
